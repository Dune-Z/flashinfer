...
## [0.2.0](https://github.com/Dune-Z/flashinfer/compare/v0.1.0...v0.2.0) (2024-07-20)


### Features

* add `use_tensor_cores` option to decode kernels to accelerate GQA ([#317](https://github.com/Dune-Z/flashinfer/issues/317)) ([3b50dd5](https://github.com/Dune-Z/flashinfer/commit/3b50dd59b0e1f23905e583d5af069e43ff5e15a4))
* add group gemm operators ([#282](https://github.com/Dune-Z/flashinfer/issues/282)) ([e08ba42](https://github.com/Dune-Z/flashinfer/commit/e08ba4226f694d5469cce4233f1854c965f05197))
* Add mask to `merge_state_in_place` ([#372](https://github.com/Dune-Z/flashinfer/issues/372)) ([e14fa81](https://github.com/Dune-Z/flashinfer/commit/e14fa8194cfc09c271e6f2c102060698f18297a9))
* add mma instructions for fp8 ([#179](https://github.com/Dune-Z/flashinfer/issues/179)) ([d305798](https://github.com/Dune-Z/flashinfer/commit/d3057983e6d47e857ec3956de94eb11f62d9d83e))
* adding `sm_scale` field for all attention APIs ([#145](https://github.com/Dune-Z/flashinfer/issues/145)) ([85d4018](https://github.com/Dune-Z/flashinfer/commit/85d4018de4766dafd1be60cf6d953cd9236a4058))
* customize `logits_soft_cap` value ([#339](https://github.com/Dune-Z/flashinfer/issues/339)) ([a2498f5](https://github.com/Dune-Z/flashinfer/commit/a2498f511b354ce049bda6be320a24b73c719be3))
* enable `head_dim=256` for attention kernels ([#132](https://github.com/Dune-Z/flashinfer/issues/132)) ([0372acc](https://github.com/Dune-Z/flashinfer/commit/0372acc44d0d393af7fd9fb3dcef0ff25953d4e1))
* expose decoupled kv-cache to pytorch api ([#383](https://github.com/Dune-Z/flashinfer/issues/383)) ([457a0ae](https://github.com/Dune-Z/flashinfer/commit/457a0ae0c8a43bd95a803167e28be19555a2ebf8))
* expose pytorch api for block sparse attention ([#375](https://github.com/Dune-Z/flashinfer/issues/375)) ([4bba6fa](https://github.com/Dune-Z/flashinfer/commit/4bba6fa3aa848d2e43248bca8d959fd58a27cfa4))
* Fused GPU sampling kernel for joint top-k & top-p sampling ([#374](https://github.com/Dune-Z/flashinfer/issues/374)) ([6e028eb](https://github.com/Dune-Z/flashinfer/commit/6e028eb997173658832a66c7480cc9224d637a15))
* initial support of distributed operators ([#289](https://github.com/Dune-Z/flashinfer/issues/289)) ([03553da](https://github.com/Dune-Z/flashinfer/commit/03553dac1dffff9a6867be0d5676d69d6eeae18c))
* initial support of logits hook ([#298](https://github.com/Dune-Z/flashinfer/issues/298)) ([ab1e2ad](https://github.com/Dune-Z/flashinfer/commit/ab1e2ad89f27319f5b4874c5e8b526c1cae43598))
* mma rowsum for fp8 ([#180](https://github.com/Dune-Z/flashinfer/issues/180)) ([5af935c](https://github.com/Dune-Z/flashinfer/commit/5af935ca783d3487034110902c6406089c31acbc))
* pytorch api of fp8 kv-cache ([#156](https://github.com/Dune-Z/flashinfer/issues/156)) ([66ee066](https://github.com/Dune-Z/flashinfer/commit/66ee06683eaea7efe724c46df528ae47aa75eca2))
* Separate Q and KV dtypes for decode ([#286](https://github.com/Dune-Z/flashinfer/issues/286)) ([5602659](https://github.com/Dune-Z/flashinfer/commit/5602659d8cd0616ec8214d056ea5c4078b21342b))
* support ALiBi ([#146](https://github.com/Dune-Z/flashinfer/issues/146)) ([383518b](https://github.com/Dune-Z/flashinfer/commit/383518bdf1824f68d33a2eaafd72a780f195bdd4))
* support any num_heads for get_alibi_slope ([#200](https://github.com/Dune-Z/flashinfer/issues/200)) ([b217a6f](https://github.com/Dune-Z/flashinfer/commit/b217a6fefb7bd091469467d32b8aedde4a25cad7))
* support cuda graph for batched multi-query(prefill/append) attention ([#275](https://github.com/Dune-Z/flashinfer/issues/275)) ([83ceb67](https://github.com/Dune-Z/flashinfer/commit/83ceb67a5773b0447f5f0344411abfdbc53cf5f4))
* support cuda graph for batched multi-query(prefill/append) attention ([#277](https://github.com/Dune-Z/flashinfer/issues/277)) ([24cc583](https://github.com/Dune-Z/flashinfer/commit/24cc583cb6b1a205aa8aad53f56472305b73f5f4))
* support custom attention mask in prefill/append attention kernels ([#266](https://github.com/Dune-Z/flashinfer/issues/266)) ([7304282](https://github.com/Dune-Z/flashinfer/commit/7304282a8068942100f8e59adff533ce28f4d3e5))
...
* bugfix to pr 135 ([#136](https://github.com/Dune-Z/flashinfer/issues/136)) ([3d55c71](https://github.com/Dune-Z/flashinfer/commit/3d55c71a62052c590c130897d3a3db49b14fcc34))
* disable other warp layout because of large binary size ([#326](https://github.com/Dune-Z/flashinfer/issues/326)) ([c146e06](https://github.com/Dune-Z/flashinfer/commit/c146e068bae01750c3afdbe8a14879183941cb06))
* fatal bugfix in batch decode operator ([#177](https://github.com/Dune-Z/flashinfer/issues/177)) ([238563f](https://github.com/Dune-Z/flashinfer/commit/238563fb8fa5f3e5906bb951c3ee84659ed9265a))
* fix bugs introduced in [#132](https://github.com/Dune-Z/flashinfer/issues/132) ([#135](https://github.com/Dune-Z/flashinfer/issues/135)) ([9b7b0b9](https://github.com/Dune-Z/flashinfer/commit/9b7b0b913e1fbef7aac6351109911c7ac08a8904))
* fix FindThrust.cmake ([#161](https://github.com/Dune-Z/flashinfer/issues/161)) ([30fa584](https://github.com/Dune-Z/flashinfer/commit/30fa5843aeb1ac48816967a63db140cff6044e13))
* fix macro to suppress compilation warning ([#231](https://github.com/Dune-Z/flashinfer/issues/231)) ([94bcf6f](https://github.com/Dune-Z/flashinfer/commit/94bcf6f27b0e92da8b9f8fc2dffd0af31756e1da))
* fix python package dispatch error message ([#182](https://github.com/Dune-Z/flashinfer/issues/182)) ([8eed01c](https://github.com/Dune-Z/flashinfer/commit/8eed01c094ceb47375a1d4da8748c43a2947e959))
...
* remove 8 from default page size ([#233](https://github.com/Dune-Z/flashinfer/issues/233)) ([62343e6](https://github.com/Dune-Z/flashinfer/commit/62343e66039a25cd49e89c8fe11fac153dd4bfee))
...
* accelerate alibi ([#365](https://github.com/Dune-Z/flashinfer/issues/365)) ([4f0a9f9](https://github.com/Dune-Z/flashinfer/commit/4f0a9f987ad2036f3c466257459de823be85fcc6))
* accelerate gqa performance ([#356](https://github.com/Dune-Z/flashinfer/issues/356)) ([e56ddad](https://github.com/Dune-Z/flashinfer/commit/e56ddadf4bdbb164c3f1a03f9f69cb8a25621ef5))
* change minimal `kv_chunk_size` back to 128 ([#329](https://github.com/Dune-Z/flashinfer/issues/329)) ([f237f5f](https://github.com/Dune-Z/flashinfer/commit/f237f5f80199e2c433fcca750713c6e774693b58))
* initial cuda graph support ([#256](https://github.com/Dune-Z/flashinfer/issues/256)) ([7e9cc7f](https://github.com/Dune-Z/flashinfer/commit/7e9cc7ff42ca283c317061a877305d09a395fad2))
* more options for kv tile size ([#336](https://github.com/Dune-Z/flashinfer/issues/336)) ([bf2a6c7](https://github.com/Dune-Z/flashinfer/commit/bf2a6c7c05a82e0ee0ea04381d04b84327355b69))
* multiple q by sm_scale in decode kernels ([#144](https://github.com/Dune-Z/flashinfer/issues/144)) ([660c559](https://github.com/Dune-Z/flashinfer/commit/660c559348ba9710d0d81b53f710f7e4951eee2b))
* Optimize tensor conversions in C++ code to avoid unnecessary copies ([#366](https://github.com/Dune-Z/flashinfer/issues/366)) ([1116237](https://github.com/Dune-Z/flashinfer/commit/1116237ac1e5690cf404841327b58b1d268d9951))
* split kv-cache for prefill/append kernels ([#310](https://github.com/Dune-Z/flashinfer/issues/310)) ([f0bb0a3](https://github.com/Dune-Z/flashinfer/commit/f0bb0a3a723cbe1a138c604680e6b573d877f210))
* use 1x4 warp layout for small query length ([#322](https://github.com/Dune-Z/flashinfer/issues/322)) ([4e89b4d](https://github.com/Dune-Z/flashinfer/commit/4e89b4dfdeb0c07b290ace9f82edf31e63136cfd))
* use packed bit array for attention mask ([#308](https://github.com/Dune-Z/flashinfer/issues/308)) ([3d43dc9](https://github.com/Dune-Z/flashinfer/commit/3d43dc9dc1a2ae804eaa7e40b4555e471fd03fe3))
* use stmatrix in epilogue for sm90+ ([#380](https://github.com/Dune-Z/flashinfer/issues/380)) ([c6f20d1](https://github.com/Dune-Z/flashinfer/commit/c6f20d1406a3a8c4f134c4a764d16e157a184338))
